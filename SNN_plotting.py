...
ax1.set_title('A. 28% decrease, 10% of the synaptic weights', loc = 'center')
...
ax3.set_title('C. 28% decrease, 100% of the synaptic weights')
...
ax1 = fig.add_subplot(gs[0, 0])
for i in range(20):
    ax1.plot(sch_normaltrace[:] / ms, sch_normalv[i*100+999,:] / mV, label = i+10, alpha = 0.3)
ax1.plot(sch_normaltrace[:]/ ms, sch_normalv[1400,:] / mV, color = 'maroon')
...
ax2 = fig.add_subplot(gs[0, 1])
for i in range(20):
    ax2.plot(snn_normaltrace[:] / ms, snn_normalv[i*65+600,:] / mV, label = i+10, alpha = 0.3)
ax2.plot(snn_normaltrace[:]/ ms, snn_normalv[850,:] / mV, color = 'maroon')
ax2.spines['right'].set_visible(False)
ax2.spines['top'].set_visible(False)
ax2.set_ylim(-60,-34)
ax2.set_xlim(60,110)
